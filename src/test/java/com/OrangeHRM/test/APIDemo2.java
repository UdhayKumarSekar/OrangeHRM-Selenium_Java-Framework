...
//	The validation done using  Soft ASSERT
...
//	3. Status codes Validation
		...
		softassert.assertTrue(IsValidStatusCode, "Status Code Not Matching:  No Expected Response");
...
//	4. User name Validation
		...
		softassert.assertTrue(isUserNameValid, "User Name is Not Matching");
